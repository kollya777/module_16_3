...
async def create_message(user_name: Annotated[str, Path(min_length=5, max_length=20, description="Enter username", examples="Den")],
...
async def update_message(user_name: Annotated[str, Path(min_length=5, max_length=20, description="Enter username", examples="Den")],
